...
|---|---|---|
| Project (default) | _(none)_ | `.claude/skills/…`, `.agents/skills/…`, etc. |
...
**GitHub Copilot** — symlink into `~/.copilot/skills/`:
...
**Codex / Cursor / Cline / Warp** — symlink into agent-specific directory:
